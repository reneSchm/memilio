...
// g++ --std=c++17 -Wall --pedantic -Icpp -Icpp/build/memilio -Icpp/build/_deps/eigen-src -Icpp/build/_deps/jsoncpp-src/include/ -Wl,-rpath,$(pwd)/cpp/build/lib map_apply_border_weights.cpp cpp/build/lib/libjsoncpp.so
